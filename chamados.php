        ...
        <div class="row g-5 align-items-center">
            <div class="col-12">
                <div class="form-container">
                    <h2 class="text-center mb-4">Formulário de Chamado</h2>
                    <form action="../DAO/chamado/chamadoPost.php" method="POST">
                        <!-- Campo de Descrição -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="imagem" class="form-label">Adicionar Imagens</label>
                            <input class="form-control" type="file" id="imagem" accept="image/*" multiple>
                        </div>
